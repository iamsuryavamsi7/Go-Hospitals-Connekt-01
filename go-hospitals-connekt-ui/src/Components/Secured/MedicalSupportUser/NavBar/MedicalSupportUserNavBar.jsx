        ...
        client.connect(
            ...
            () => {
                ...
                client.subscribe(`/common/commonFunction`, (message) => {
                    ...
                    if ( messageObject.notificationType === `FollowUpPatientCame` || messageObject.notificationType === `MedicinesGiven` || messageObject.notificationType === `MedicinesGivenMedicalSupport` || messageObject.notificationType === `CrossConsultationCaseClosed` || messageObject.notificationType === `CrossConsultationDroppedOut` || messageObject.notificationType === `CounsellingDoneSurgeryCare` || messageObject.notificationType === 'RefreshMedicalSupportNotification' ){

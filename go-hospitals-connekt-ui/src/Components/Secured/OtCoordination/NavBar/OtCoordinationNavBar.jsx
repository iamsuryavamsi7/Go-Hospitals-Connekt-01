...
const OtCoordinationNavBar = () => {
    ...
    // State to store the Pharmacy role
    ...
    const notificationFunction = async (notificationObject) => {
        ...
        if ( notificationStatus === 'BOOKAPPOINTMENT' ){
            ...
            navigate(`/ot-coordination-profiles/${applicationID}`);
    ...
    const newNotificationFunction = (message) => {
        ...
        if ( messageobject.notificationType === `RefreshOtCoordinationNotifications` ){
    ...
    return (
        ...
        <>
            ...
            { role === pharmacy && <div className="h-16 flex items-center justify-between border-[1px] border-gray-800 fixed z-50 top-0 left-0 right-0 bg-[#0F172A]">
...
export default OtCoordinationNavBar
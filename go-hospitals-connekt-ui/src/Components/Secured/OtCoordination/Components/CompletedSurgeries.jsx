...
const CompletedSurgeries = () => {
    ...
    const fetchcompleteApplications = async () => {
        ...
        try {
            ...
            const response = await axios.get(`${goHospitalsAPIBaseURL}/api/v1/ot-coordination/fetchAllCompleteApplications/${page}/${pageSize}`, {
                headers: {
    ...
    const fetchcompleteApplications2 = async (page) => {
    ...
    const nextPage = async () => {
        ...
        if ( !isLastPage ) {
            ...
            const hasPage = await fetchcompleteApplications2(pageNumber);

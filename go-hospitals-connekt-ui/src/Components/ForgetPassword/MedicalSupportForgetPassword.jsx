...
const MedicalSupportForgetPassword = () => {
            ...
            try{
                ...
                if ( response.status  === 200 ){
                    ...
                    setTimeout(() => {
                        ...
                        navigate('/medical-support-login');
                ...
                <>
                    ...
                    {loading ? (
                        ...
                        <ToastContainer />
                            ...
                            <div className="flex-1 loginPageImage2 m-2 max-sm:hidden">
...
export default MedicalSupportForgetPassword
...
// Functions
    ...
    const formSubmitFunction = async (e) => {
        ...
        try{
            ...
            const response = await axios.post('http://localhost:7777/api/v1/auth/authenticate-transport-team', loginData);
        ...
        <>
            ...
            {loading ? (
                ...
                <div className="absolute max-sm:relative top-0 bottom-0 left-0 right-0 flex">
                        ...
                        <div className="">
                            ...
                            >
                                ...
                                <span 
                                    ...
                                    onClick={() => navigate('/transport-team-register')}
                    ...
                    <div className="flex-1 loginPageImage7 m-2 max-sm:hidden">
